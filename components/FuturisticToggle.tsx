...
export const FuturisticToggle: React.FC<FuturisticToggleProps> = ({ 
  ...
  return (
    <div className="flex bg-slate-950 border border-slate-700 p-1 rounded-sm relative w-full md:w-auto min-w-[200px] cursor-pointer" onClick={() => onChange(isRight ? leftValue : rightValue)}>
      {/* Background slider */}
      <div 
